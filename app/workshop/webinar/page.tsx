...
const WebinarPage = () => {
  ...
  return (
    <div className="lg:h-[45rem] h-[100rem] w-full rounded-md dark:bg-black bg-white relative flex flex-col items-center justify-center antialiased font-circular my-32">
